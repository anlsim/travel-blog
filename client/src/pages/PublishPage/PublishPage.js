            ...
            <div className="publishMain-form">
                ...
                <form className="mainForm" onSubmit={handlePublish}>
                    ...
                    <textarea 
                        ...
                        ></textarea>
                    <button className="mainForm-button" type="submit">Publish your post!</button>
                </form>
            </div>
            <div className="publishMain-form">
                ...
                <form className="mainForm" onSubmit={handlePhotos}>   
                    ...
                    <input 
                        ...
                        onChange={e=> setPhotoData({...photoData, thumbnail: e.target.value})}
                    />
                    <input 
                        className="mainForm-input" 
                        type="text" 
                    ...
                    <input 
                        ...
                        type="text" 
                        placeholder="Post Id"
                        onChange={e=> setPhotoData({...photoData, postId: (e.target.value)})}
                    />
                    <button className="mainForm-button" type="submit">Publish your Picture to gallery!</button> 
                </form>
            </div>
        </div>
    )
