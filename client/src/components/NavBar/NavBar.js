...
export default function NavBar() {
  ...
  return (
    ...
    <nav className="navBar">
      <Link className="navBar__logo" to="/">Travel Blog</Link>
          ...
          <>
            ...
            <div className="navBar__settings">
              <li className="navBar__menu__links nav-item" title="SETTINGS">
                    <Link to="/settings"> <i className="far fa-user-circle"></i>  Settings</Link>
              </li>
              <li  className="navBar__menu__links nav-item" onClick={handleLogOut}>
